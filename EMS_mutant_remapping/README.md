...
📥 Inputs  
• `exome_MAPS_groups.list`: SRA identifiers for exome-capture data (Note: this list does not contain redundant accessions. Download everything from PRJNA258539, except for SRX2433935 (Kronos3690; SRR5118653) which we found essentially no mutations.)
